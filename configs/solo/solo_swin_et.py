...
from deepdisc.data_format.augment_image import dc2_train_augs, dc2_train_augs_full, roman_train_augs, roman_train_augs_elastic
from deepdisc.data_format.image_readers import RomanImageReader

# Overrides
dataloader.augs = roman_train_augs_elastic
