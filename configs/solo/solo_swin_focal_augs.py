...
# ---------------------------------------------------------------------------- #
epoch=588 #(TRAINING NUM OF IMAGES / BATCH SIZE 280/4 2351/4)
...
from deepdisc.data_format.augment_image import dc2_train_augs, dc2_train_augs_full, roman_train_augs, roman_train_focal
...
model.roi_heads.update(
    box_predictors=[
        L(FastRCNNOutputLayers)(
            ...
            use_focal_ce = True,
            focal_alpha = 0.25, # controls the balance between pos and neg examples. apply same weight to minority class (stars) and  1 - alpha to majority class (galaxies)
            focal_gamma = 2.0,
        )
        for (w1, w2) in [(10, 5), (20, 10), (30, 15)]
    ],
)
dataloader.augs = roman_train_focal
