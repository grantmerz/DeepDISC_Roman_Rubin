...
from ..custom.readers import CombinedImageReader
...
model.backbone.bottom_up.stem.in_channels=10
model.backbone.square_pad = 525

model.pixel_mean = [0.5832018]*10
model.pixel_std = [20.610922]*10
...
#train.init_checkpoint = model_zoo.get_checkpoint_url("Misc/cascade_mask_rcnn_R_50_FPN_3x.yaml")
#train.init_checkpoint = '/home/shared/hsc/detectron2/R-50.pkl'
#train.init_checkpoint = "/home/g4merz/JWST/models/pretraining/GMLremove9813_R50bb_ms01_d2.pth"
...
reader = CombinedImageReader()
dataloader.imagereader = reader



#dataloader.indsplit_file = '/home/g4merz/JWST/configs/solo/by_area_compresample_new_kfoldinds.json'
#dataloader.indsplit_fold = '0'
