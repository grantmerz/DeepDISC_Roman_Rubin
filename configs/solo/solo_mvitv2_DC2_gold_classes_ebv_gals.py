...
#Need to use this if only using the Swin backbone
...
model.roi_heads._target_ = roiheads.RedshiftPDFCasROIHeadsGoldEBVGals
...
dataloader.train.mapper = MagRedshiftDictMapperNlimWithStars
