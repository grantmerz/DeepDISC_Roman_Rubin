#!/bin/bash
#SBATCH -J only_moco5_30k_rubin_test
#SBATCH --output=/projects/bfhm/yse2/logs/training_logs/only_moco5_30k_rubin_test_out.%j.out
#SBATCH --error=/projects/bfhm/yse2/logs/training_logs/only_moco5_30k_rubin_test_err.%j.err
...
CFG_FILE="/u/yse2/deepdisc/configs/solo/swin_lsst_job_moco_lsst.py"
...
RUN_NAME="only_moco5_30k_rubin_test"
OUTPUT_DIR="./lsst_runs/${RUN_NAME}"

echo "Launching DeepDISC training job..."

# python run_model_job_moco_lsst.py --cfgfile /u/yse2/deepdisc/configs/solo/swin_lsst_job_moco_lsst.py --train-metadata /u/yse2/lsst_data/annotations_lvl5/train_30k.json --eval-metadata /u/yse2/lsst_data/annotations_lvl5/val_4k.json --num-gpus 4 --run-name moco5_30k_rubin_test --output-dir ./lsst_runs/moco5_30k_rubin_test

python run_model_job_moco_lsst.py \
    --cfgfile ${CFG_FILE} \
