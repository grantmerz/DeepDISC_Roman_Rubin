#!/bin/bash
#SBATCH -J clip5_all
#SBATCH --output=/projects/bfhm/yse2/logs/training_logs/clip5_all_out.%j.out
#SBATCH --error=/projects/bfhm/yse2/logs/training_logs/clip5_all_err.%j.err
...
python train_clip_model_100k.py \
    --cfgfile ${CFG_FILE} \
