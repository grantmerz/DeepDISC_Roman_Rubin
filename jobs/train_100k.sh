#!/bin/bash
#SBATCH -J lsst5_all
#SBATCH --output=/projects/bfhm/yse2/logs/training_logs/lsst5_all_out.%j.out
#SBATCH --error=/projects/bfhm/yse2/logs/training_logs/lsst5_all_err.%j.err
