...
class GeneralizedRCNNMoco(nn.Module):
    """
    Generalized R-CNN with Moco v2 for Roman-LSST semi-supervised training, 
    ...
    def __init__(
        self,
        *,
        backbone_q: Backbone, # lsst - Query encoder providing us the features to be aligned
        backbone_k: Backbone, # roman - Key/Momentum encoder providing us high-quality features as a ref
        #mlp: nn.Module,
        proposal_generator: nn.Module,
        roi_heads: nn.Module,
        pixel_mean_lsst: Tuple[float],
        pixel_std_lsst: Tuple[float],
        pixel_mean_roman: Tuple[float],
        pixel_std_roman: Tuple[float],
